...
afterSignOutUrl="/"
      appearance={{
        ...
        elements: {
          ...
          userPreviewSecondaryIdentifier: { color: 'rgba(255,255,255,0.6)' },
          profileSectionTitle: { color: '#ffffff' },
          profileSectionTitleText: { color: '#ffffff' },
          profileSectionContent: { color: '#ffffff' },
          profileSectionPrimaryButton: { color: '#0A84FF' },
          accordionTriggerButton: { color: '#ffffff' },
          navbarButton: { color: '#ffffff' },
          navbarButtonIcon: { color: 'rgba(255,255,255,0.6)' },
          pageScrollBox: { background: '#1c1c1e' },
          navbar: { background: '#1c1c1e', borderRight: '1px solid rgba(255,255,255,0.08)' },
          page: { background: '#1c1c1e' },
          modalContent: { background: '#1c1c1e' },
          modalCloseButton: { color: '#ffffff' },
          headerBackRow: { color: '#ffffff' },
          breadcrumbs: { color: '#ffffff' },
          breadcrumbsItem: { color: 'rgba(255,255,255,0.5)' },
          breadcrumbsItemDivider: { color: 'rgba(255,255,255,0.3)' },
          formButtonPrimary: { background: '#0A84FF', color: '#ffffff' },
